  ...
  **/
  class Transfer
  {
    public:
      ...
      **/
      Transfer(const uint16_t* pSource = nullptr,
                  const uint16_t& transferCount = 0,
                  volatile uint16_t* pDest = nullptr,
                  const uint16_t& fill = 0,
...
//      private:
      ...
      const uint16_t* m_pSource;
      uint16_t m_transferCount;
      volatile uint16_t* m_pDest;
      uint16_t m_fill;
      Transfer* m_pNext;
...
class AbstractDmaSpi
{
  ...
  protected:
    ...
    static volatile uint16_t m_devNull;
...
template<typename DMASPI_INSTANCE, typename SPICLASS, SPICLASS& m_Spi>
volatile uint16_t AbstractDmaSpi<DMASPI_INSTANCE, SPICLASS, m_Spi>::m_devNull = 0;
...
public:
  ...
  {
    txChannel_()->disable();
    txChannel_()->destination((volatile uint16_t&)SPI0_PUSHR);
  ...
  {
    rxChannel_()->disable();
    rxChannel_()->source((volatile uint16_t&)SPI0_POPR);
...
public:
  ...
  {
    txChannel_()->disable();
    txChannel_()->destination((volatile uint16_t&)SPI1_PUSHR);
    txChannel_()->disableOnCompletion();
  ...
  {
    rxChannel_()->disable();
    rxChannel_()->source((volatile uint16_t&)SPI1_POPR);
    rxChannel_()->disableOnCompletion();
...
public:
  ...
  {
    txChannel_()->disable();
    txChannel_()->destination((volatile uint16_t&)SPI0_DL);
    txChannel_()->disableOnCompletion();
    txChannel_()->triggerAtHardwareEvent(DMAMUX_SOURCE_SPI0_TX);
  }
  ...
  {
    rxChannel_()->disable();
    rxChannel_()->source((volatile uint16_t&)SPI0_DL);
    rxChannel_()->disableOnCompletion();
    rxChannel_()->triggerAtHardwareEvent(DMAMUX_SOURCE_SPI0_RX);
    rxChannel_()->attachInterrupt(rxIsr_);
    rxChannel_()->interruptAtCompletion();
...
public:
  ...
  {
    txChannel_()->disable();
    txChannel_()->destination((volatile uint16_t&)SPI1_DL);
    txChannel_()->disableOnCompletion();
    txChannel_()->triggerAtHardwareEvent(DMAMUX_SOURCE_SPI1_TX);
  }
  ...
  {
    rxChannel_()->disable();
    rxChannel_()->source((volatile uint16_t&)SPI1_DL);
    rxChannel_()->disableOnCompletion();
    rxChannel_()->triggerAtHardwareEvent(DMAMUX_SOURCE_SPI1_RX);
    rxChannel_()->attachInterrupt(rxIsr_);
    rxChannel_()->interruptAtCompletion();
...
public:
  ...
  {
    txChannel_()->disable();
    txChannel_()->destination((volatile uint16_t&)IMXRT_LPSPI4_S.TDR);
    txChannel_()->disableOnCompletion();
  ...
  {
    rxChannel_()->disable();
    rxChannel_()->source((volatile uint16_t&)IMXRT_LPSPI4_S.RDR);
    rxChannel_()->disableOnCompletion();
  ...
  static void pre_cs_impl()
  {
    //IMXRT_LPSPI4_S.TCR = (IMXRT_LPSPI4_S.TCR & ~(LPSPI_TCR_FRAMESZ(31))) | LPSPI_TCR_FRAMESZ(15);
...
public:
  ...
  {
    txChannel_()->disable();
    txChannel_()->destination((volatile uint16_t&)IMXRT_LPSPI3_S.TDR);
    txChannel_()->disableOnCompletion();
  ...
  {
    rxChannel_()->disable();
    rxChannel_()->source((volatile uint16_t&)IMXRT_LPSPI3_S.RDR);
    rxChannel_()->disableOnCompletion();
  ...
  static void pre_cs_impl()
  {
    //IMXRT_LPSPI3_S.TCR = (IMXRT_LPSPI3_S.TCR & ~(LPSPI_TCR_FRAMESZ(31))) | LPSPI_TCR_FRAMESZ(15);  
...
public:
  ...
  {
    txChannel_()->disable();
    txChannel_()->destination((volatile uint16_t&)IMXRT_LPSPI1_S.TDR);
    txChannel_()->disableOnCompletion();
  ...
  {
    rxChannel_()->disable();
    rxChannel_()->source((volatile uint16_t&)IMXRT_LPSPI1_S.RDR);
    rxChannel_()->disableOnCompletion();
  ...
  static void pre_cs_impl()
  {
    IMXRT_LPSPI1_S.TCR = (IMXRT_LPSPI1_S.TCR & ~(LPSPI_TCR_FRAMESZ(31))) | LPSPI_TCR_FRAMESZ(15);  
